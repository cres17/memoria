...
enum CropRatioPreset {
  ...
  String get label {
    switch (this) {
      ...
      case CropRatioPreset.original: return '원본';
      ...
      case CropRatioPreset.r4x5:     return '4:5';
      case CropRatioPreset.r5x4:     return '5:4';
      case CropRatioPreset.r5x7:     return '5:7';
      case CropRatioPreset.r7x5:     return '7:5';
      case CropRatioPreset.r8x10:    return '8:10';
      case CropRatioPreset.r10x8:    return '10:8';
    }
  }
  ...
  double? get ratio {
    switch (this) {
      ...
      case CropRatioPreset.original: return -1.0; // Sentinel value for original ratio
