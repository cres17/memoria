...
void main() {
  group('filter numeric goldens', () {
    ...
    const expected = <String, String>{
      ...
      'fuji_provia': '157523,159192,157139,231568662',
      'leica_m8': '211058,194461,203840,3605974218',
      'custom_warm': '150030,140826,127549,3515173902',
      'high_saturation_velvia': '149500,141667,133833,116473701',
    };
