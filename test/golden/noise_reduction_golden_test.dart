...
void main() {
  group('noise reduction numeric goldens', () {
    final cases = <String, AdjustParams>{
      'mild_luma': const AdjustParams(
        luminanceNR: 35.0,
        colourNR: 0.0,
        nrDetail: 40.0,
      ),
      'strong_chroma': const AdjustParams(
        luminanceNR: 0.0,
        colourNR: 70.0,
        nrDetail: 50.0,
      ),
      'heavy_mixed': const AdjustParams(
        luminanceNR: 75.0,
        colourNR: 65.0,
        nrDetail: 75.0,
      ),
    ...
    final expected = <String, String>{
      'mild_luma': '139289,137544,140912,3611789099',
      'strong_chroma': '139713,137704,141097,1932161007',
      'heavy_mixed': '139583,137595,141005,547596654',
    };
