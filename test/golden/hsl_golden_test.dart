...
void main() {
  group('HSL numeric goldens', () {
    ...
    final expected = <String, String>{
      'sky': '145549,141975,154361,802471189',
      'foliage': '133586,149773,130421,3211978764',
      'skin': '141655,139451,146773,3671794581',
      'product_red': '142433,136613,139560,138630301',
      'mixed_neon': '138495,140991,139440,539698235',
    };
