...
void main() {
  group('Details Engine Tests', () {
    ...
    test('structure modifies edge contrast', () {
      ...
      final out = _play(
        original,
        const AdjustParams(structure: 50),
      );
...
img.Image _play(img.Image original, AdjustParams params) =>
    applyImagePipeline(image: original, params: params);
